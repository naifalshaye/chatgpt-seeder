...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getGenerateRetry: function getGenerateRetry() {
      var _this = this;
      Nova.request().get('/nova-vendor/chatgpt-seeder/get-generate-retry', {}).then(function (_ref) {
        var data = _ref.data;
    ...
    getTables: function getTables() {
      var _this2 = this;
      Nova.request().get('/nova-vendor/chatgpt-seeder/tables', {}).then(function (_ref2) {
        var data = _ref2.data;
    ...
    getColumns: function getColumns(table) {
      ...
      Nova.request().get('/nova-vendor/chatgpt-seeder/columns/' + table.target.value, {}).then(function (_ref3) {
        var data = _ref3.data;
    ...
    generate: function generate() {
      ...
      if (this.retry_count <= this.generate_retry) {
        ...
        Nova.request().post('/nova-vendor/chatgpt-seeder/generate', this.form).then(function (_ref4) {
          var data = _ref4.data;
    ...
    proceed: function proceed() {
      ...
      Nova.request().post('/nova-vendor/chatgpt-seeder/proceed', this.form).then(function (_ref5) {
        var data = _ref5.data;
        if (data.succeed) {
...
var _hoisted_44 = {
  key: 2,
  "class": "text-red-500 font-bold mt-4 flex justify-center"
};
var _hoisted_45 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Head, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }), 128 /* KEYED_FRAGMENT */))])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_55, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" API Usage:"), _hoisted_56, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Completion Tokens: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_this.usage.completion_tokens), 1 /* TEXT */), _hoisted_57, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Prompt Tokens: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_this.usage.prompt_tokens), 1 /* TEXT */), _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Total Tokens: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_this.usage.total_tokens), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
